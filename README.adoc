...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/namespace[kubernetes_namespace.airflow_namespace] (resource)
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret[kubernetes_secret.airflow_ssh_secret] (resource)
- https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource[null_resource.dependencies] (resource)
- https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource[null_resource.this] (resource)
- https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/password[random_password.airflow_webserver_secret_key] (resource)
...
==== [[input_fernetKey]] <<input_fernetKey,fernetKey>>
...
==== [[input_mlflow]] <<input_mlflow,mlflow>>
...
==== [[input_home_ssh]] <<input_home_ssh,home_ssh>>

Description: home ssh

Type: `string`

Default: `"/home/gerson/.ssh/id_ed25519"`

==== [[input_gitsync]] <<input_gitsync,gitsync>>
...
|`string`
|`"https://github.com/GersonRS/modern-gitops-stack-module-airflow.git"`
|no
...
|[[input_fernetKey]] <<input_fernetKey,fernetKey>>
|Fernet key settings. The Fernet key used to encrypt passwords (can only be set during install, not upgrade).
|`string`
|n/a
|yes

|[[input_oidc]] <<input_oidc,oidc>>
|OIDC configuration to access the Airflow web interface.
|
